                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="Formulario">
									<form data-toggle="validator" role="form" id="frm-trabajo-archivo" enctype="multipart/form-data"  action="?c=trabajo&a=Guardar" method="post" >
                                        <input type="hidden" name="trabajo_caracteristica" value="1" />
										...
										<div class="form-group col-lg-6">
                                            <label>Area</label>
                                            <input class="form-control" name="trabajo_editorial" value="<?php echo $pvd->trabajo_editorial; ?>"  placeholder="Ingrese Editorial"pattern="^[a-zA-Z\s]+$" data-error="Debe de contener solo letras" required>
											<div class="help-block with-errors"></div>
										</div>
										<div class="form-group col-lg-12" >
										<label>Tipo</label>
