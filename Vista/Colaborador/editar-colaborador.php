                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="Formulario">
									<form data-toggle="validator" role="form" id="frm-colaborador" action="?c=colaborador&a=Editar" method="post" enctype="multipart/form-data">
										...
										<div class="form-group col-lg-12">
                                            <label><?php echo $pvd->persona_nombres; ?> - <?php echo $pvd->persona_cui; ?></label>
                                        </div>
